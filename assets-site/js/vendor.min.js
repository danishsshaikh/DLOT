! function(t, e) {
        ...
        typeCheckConfig: function(t, e, i) {
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    var s = i[n],
                        o = e[n],
                        r = o && m.isElement(o) ? "element" : {}.toString.call(o).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    var s, a = "alert",
        ...
        f = ((s = g.prototype).close = function(t) {
            var e = this._element;
            ...
            var e = m.getSelectorFromElement(t),
                i = !1;
            return e && (i = document.querySelector(e)), i || p(t).closest(".alert")[0]
    ...
    p(document).on(d.CLICK_DATA_API, '[data-dismiss="alert"]', f._handleDismiss(new f)), p.fn[a] = f._jQueryInterface, p.fn[a].Constructor = f, p.fn[a].noConflict = function() {
        return p.fn[a] = c, f._jQueryInterface
    };
    var v, _ = "button",
        y = "bs.button",
        w = "." + y,
        ...
        I = {
            ...
            LOAD_DATA_API: "load" + w + b
        },
        A = ((v = k.prototype).toggle = function() {
            var t = !0,
                e = !0,
            ...
            if (i) {
                ...
                if (n) {
                    if ("radio" === n.type)
                        if (n.checked && this._element.classList.contains(E)) t = !1;
                        else {
                            var s = i.querySelector(".active");
                            s && p(s).removeClass(E)
                        }
                    else("checkbox" !== n.type || "LABEL" === this._element.tagName && n.checked === this._element.classList.contains(E)) && (t = !1);
                    t && (n.checked = !this._element.classList.contains(E), p(n).trigger("change")), n.focus(), e = !1
                }
            }
            this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(E)), t && p(this._element).toggleClass(E))
        }, v.dispose = function() {
            p.removeData(this._element, y), this._element = null
        }, k._jQueryInterface = function(e) {
            return this.each(function() {
                var t = p(this).data(y);
                t || (t = new k(this), p(this).data(y, t)), "toggle" === e && t[e]()
            })
        }, o(k, null, [{
            key: "VERSION",
            get: function() {
    ...
    p(document).on(I.CLICK_DATA_API, x, function(t) {
        var e = t.target;
        if (p(e).hasClass("btn") || (e = p(e).closest(S)[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault();
        else {
            var i = e.querySelector(T);
            if (i && (i.hasAttribute("disabled") || i.classList.contains("disabled"))) return void t.preventDefault();
            A._jQueryInterface.call(p(e), "toggle")
        }
    }).on(I.FOCUS_BLUR_DATA_API, x, function(t) {
        var e = p(t.target).closest(S)[0];
        ...
        for (var t = [].slice.call(document.querySelectorAll('[data-toggle="buttons"] .btn')), e = 0, i = t.length; e < i; e++) {
            var n = t[e],
                s = n.querySelector(T);
            s.checked || s.hasAttribute("checked") ? n.classList.add(E) : n.classList.remove(E)
        }
    ...
    }), p.fn[_] = A._jQueryInterface, p.fn[_].Constructor = A, p.fn[_].noConflict = function() {
        return p.fn[_] = C, A._jQueryInterface
    };
    var D, O = "carousel",
        N = "bs.carousel",
        P = "." + N,
        ...
        B = ((D = U.prototype).next = function() {
            ...
            return t = r({}, z, {}, t), m.typeCheckConfig(O, t, H), t
            ...
            if (this._touchSupported) {
                var e = function(t) {
                        i._pointerEvent && q[t.originalEvent.pointerType.toUpperCase()] ? i.touchStartX = t.originalEvent.clientX : i._pointerEvent || (i.touchStartX = t.originalEvent.touches[0].clientX)
                    },
                    n = function(t) {
                        i._pointerEvent && q[t.originalEvent.pointerType.toUpperCase()] && (i.touchDeltaX = t.originalEvent.clientX - i.touchStartX), i._handleSwipe(), "hover" === i._config.pause && (i.pause(), i.touchTimeout && clearTimeout(i.touchTimeout), i.touchTimeout = setTimeout(function(t) {
                            return i.cycle(t)
                        }, 500 + i._config.interval))
                    };
                p(this._element.querySelectorAll(".carousel-item img")).on(F.DRAG_START, function(t) {
                    return t.preventDefault()
                }), this._pointerEvent ? (p(this._element).on(F.POINTERDOWN, function(t) {
                    return e(t)
                }), p(this._element).on(F.POINTERUP, function(t) {
                    return n(t)
                }), this._element.classList.add("pointer-event")) : (p(this._element).on(F.TOUCHSTART, function(t) {
                    return e(t)
            ...
            var i, n, s, o = this,
                r = this._element.querySelector($),
                a = this._getItemIndex(r),
                l = e || r && this._getItemByDirection(t, r),
                h = this._getItemIndex(l),
                c = Boolean(this._interval);
            if (s = t === M ? (i = "carousel-item-left", n = "carousel-item-next", "left") : (i = "carousel-item-right", n = "carousel-item-prev", "right"), l && p(l).hasClass(W)) this._isSliding = !1;
                ...
                if (p(this._element).hasClass("slide")) {
                    p(l).addClass(n), m.reflow(l), p(r).addClass(i), p(l).addClass(i);
                    ...
                    p(r).one(m.TRANSITION_END, function() {
                        p(l).removeClass(i + " " + n).addClass(W), p(r).removeClass(W + " " + n + " " + i), o._isSliding = !1, setTimeout(function() {
                            return p(o._element).trigger(u)
                        }, 0)
                    }).emulateTransitionEnd(f)
                } else p(r).removeClass(W), p(l).addClass(W), this._isSliding = !1, p(this._element).trigger(u);
                c && this.cycle()
            }
            ...
            return this.each(function() {
                ...
                if (t || (t = new U(this, e), p(this).data(N, t)), "number" == typeof n) t.to(n);
            ...
            if (e) {
                ...
                if (i && p(i).hasClass("carousel")) {
                    var n = r({}, p(i).data(), {}, p(this).data()),
                        s = this.getAttribute("data-slide-to");
                    s && (n.interval = !1), U._jQueryInterface.call(p(i), n), s && p(i).data(N).to(s), t.preventDefault()
                }
            }
        }, o(U, null, [{
            key: "VERSION",
    ...
    p(document).on(F.CLICK_DATA_API, "[data-slide], [data-slide-to]", B._dataApiClickHandler), p(window).on(F.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, i = t.length; e < i; e++) {
            var n = p(t[e]);
            B._jQueryInterface.call(n, n.data())
        }
    }), p.fn[O] = B._jQueryInterface, p.fn[O].Constructor = B, p.fn[O].noConflict = function() {
        return p.fn[O] = j, B._jQueryInterface
    };
    var Q, K = "collapse",
        V = "bs.collapse",
        Y = "." + V,
        ...
        ot = ((Q = rt.prototype).toggle = function() {
            p(this._element).hasClass(tt) ? this.hide() : this.show()
        }, Q.show = function() {
            var t, e, i = this;
            if (!(this._isTransitioning || p(this._element).hasClass(tt) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
                    return "string" == typeof i._config.parent ? t.getAttribute("data-parent") === i._config.parent : t.classList.contains(et)
                })).length && (t = null), t && (e = p(t).not(this._selector).data(V)) && e._isTransitioning))) {
                var n = p.Event(J.SHOW);
                if (p(this._element).trigger(n), !n.isDefaultPrevented()) {
                    t && (rt._jQueryInterface.call(p(t).not(this._selector), "hide"), e || p(t).data(V, null));
                    var s = this._getDimension();
                    p(this._element).removeClass(et).addClass(it), this._element.style[s] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(nt).attr("aria-expanded", !0), this.setTransitioning(!0);
                    var o = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                        r = m.getTransitionDurationFromElement(this._element);
                    p(this._element).one(m.TRANSITION_END, function() {
                        p(i._element).removeClass(it).addClass(et).addClass(tt), i._element.style[s] = "", i.setTransitioning(!1), p(i._element).trigger(J.SHOWN)
                    }).emulateTransitionEnd(r), this._element.style[s] = this._element[o] + "px"
                }
            }
        }, Q.hide = function() {
            var t = this;
            if (!this._isTransitioning && p(this._element).hasClass(tt)) {
                var e = p.Event(J.HIDE);
                if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                    var i = this._getDimension();
                    this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", m.reflow(this._element), p(this._element).addClass(it).removeClass(et).removeClass(tt);
                    var n = this._triggerArray.length;
                    if (0 < n)
                        for (var s = 0; s < n; s++) {
                            var o = this._triggerArray[s],
                                r = m.getSelectorFromElement(o);
                            null !== r && (p([].slice.call(document.querySelectorAll(r))).hasClass(tt) || p(o).addClass(nt).attr("aria-expanded", !1))
                        }
                    this.setTransitioning(!0), this._element.style[i] = "";
                    var a = m.getTransitionDurationFromElement(this._element);
                    p(this._element).one(m.TRANSITION_END, function() {
                        t.setTransitioning(!1), p(t._element).removeClass(it).addClass(et).trigger(J.HIDDEN)
            ...
            return (t = r({}, X, {}, t)).toggle = Boolean(t.toggle), m.typeCheckConfig(K, t, G), t
            ...
            return p(n).each(function(t, e) {
                i._addAriaAndCollapsedClass(rt._getTargetFromElement(e), [e])
            }), t
        }, Q._addAriaAndCollapsedClass = function(t, e) {
            var i = p(t).hasClass(tt);
            e.length && p(e).toggleClass(nt, !i).attr("aria-expanded", i)
        }, rt._getTargetFromElement = function(t) {
            var e = m.getSelectorFromElement(t);
            ...
            return this.each(function() {
                var t = p(this),
                    e = t.data(V),
                    i = r({}, X, {}, t.data(), {}, "object" == typeof n && n ? n : {});
                if (!e && i.toggle && /show|hide/.test(n) && (i.toggle = !1), e || (e = new rt(this, i), t.data(V, e)), "string" == typeof n) {
    ...
    function rt(e, t) {
        ...
        for (var i = [].slice.call(document.querySelectorAll(st)), n = 0, s = i.length; n < s; n++) {
            var o = i[n],
                r = m.getSelectorFromElement(o),
    ...
    p(document).on(J.CLICK_DATA_API, st, function(t) {
        ...
        p(n).each(function() {
            var t = p(this),
                e = t.data(V) ? "toggle" : i.data();
            ot._jQueryInterface.call(t, e)
        })
    }), p.fn[K] = ot._jQueryInterface, p.fn[K].Constructor = ot, p.fn[K].noConflict = function() {
        return p.fn[K] = Z, ot._jQueryInterface
    };
    var at, lt = "dropdown",
        ht = "bs.dropdown",
        ct = "." + ht,
        ...
        Ct = ((at = Et.prototype).toggle = function() {
            if (!this._element.disabled && !p(this._element).hasClass(mt)) {
                var t = p(this._menu).hasClass(gt);
                Et._clearMenus(), t || this.show(!0)
            }
        }, at.show = function(t) {
            if (void 0 === t && (t = !1), !(this._element.disabled || p(this._element).hasClass(mt) || p(this._menu).hasClass(gt))) {
                var e = {
                        relatedTarget: this._element
                    },
                    i = p.Event(pt.SHOW, e),
                    n = Et._getParentFromElement(this._element);
                if (p(n).trigger(i), !i.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        ...
                        var s = this._element;
                        "parent" === this._config.reference ? s = n : m.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(n).addClass("position-static"), this._popper = new u(s, this._menu, this._getPopperConfig())
                    }
                    "ontouchstart" in document.documentElement && 0 === p(n).closest(".navbar-nav").length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(gt), p(n).toggleClass(gt).trigger(p.Event(pt.SHOWN, e))
                }
            }
        }, at.hide = function() {
            if (!this._element.disabled && !p(this._element).hasClass(mt) && p(this._menu).hasClass(gt)) {
                var t = {
                        relatedTarget: this._element
                    },
                    e = p.Event(pt.HIDE, t),
                    i = Et._getParentFromElement(this._element);
                p(i).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(gt), p(i).toggleClass(gt).trigger(p.Event(pt.HIDDEN, t)))
            }
        }, at.dispose = function() {
            p.removeData(this._element, ht), p(this._element).off(ct), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
        }, at.update = function() {
            this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
        }, at._addEventListeners = function() {
            var e = this;
            p(this._element).on(pt.CLICK, function(t) {
                t.preventDefault(), t.stopPropagation(), e.toggle()
            })
        }, at._getConfig = function(t) {
            return t = r({}, this.constructor.Default, {}, p(this._element).data(), {}, t), m.typeCheckConfig(lt, t, this.constructor.DefaultType), t
        }, at._getMenuElement = function() {
            if (!this._menu) {
                var t = Et._getParentFromElement(this._element);
                t && (this._menu = t.querySelector(yt))
            }
            return this._menu
        }, at._getPlacement = function() {
            var t = p(this._element.parentNode),
                e = "bottom-start";
            return t.hasClass("dropup") ? (e = "top-start", p(this._menu).hasClass(vt) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : p(this._menu).hasClass(vt) && (e = "bottom-end"), e
        }, at._detectNavbar = function() {
            return 0 < p(this._element).closest(".navbar").length
        }, at._getOffset = function() {
            var e = this,
                t = {};
            ...
            return this.each(function() {
                var t = p(this).data(ht);
                if (t || (t = new Et(this, "object" == typeof e ? e : null), p(this).data(ht, t)), "string" == typeof e) {
            ...
            if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                for (var e = [].slice.call(document.querySelectorAll(_t)), i = 0, n = e.length; i < n; i++) {
                    var s = Et._getParentFromElement(e[i]),
                        o = p(e[i]).data(ht),
                        r = {
                            relatedTarget: e[i]
                        };
                    if (t && "click" === t.type && (r.clickEvent = t), o) {
                        var a = o._menu;
                        if (p(s).hasClass(gt) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(s, t.target))) {
                            var l = p.Event(pt.HIDE, r);
                            p(s).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[i].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), p(a).removeClass(gt), p(s).removeClass(gt).trigger(p.Event(pt.HIDDEN, r)))
                        }
                    }
                }
            ...
            if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(yt).length)) : ft.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(mt))) {
    ...
    p(document).on(pt.KEYDOWN_DATA_API, _t, Ct._dataApiKeydownHandler).on(pt.KEYDOWN_DATA_API, yt, Ct._dataApiKeydownHandler).on(pt.CLICK_DATA_API + " " + pt.KEYUP_DATA_API, Ct._clearMenus).on(pt.CLICK_DATA_API, _t, function(t) {
        t.preventDefault(), t.stopPropagation(), Ct._jQueryInterface.call(p(this), "toggle")
    }).on(pt.CLICK_DATA_API, ".dropdown form", function(t) {
        t.stopPropagation()
    }), p.fn[lt] = Ct._jQueryInterface, p.fn[lt].Constructor = Ct, p.fn[lt].noConflict = function() {
        return p.fn[lt] = dt, Ct._jQueryInterface
    };
    var xt, Tt = "modal",
        St = "bs.modal",
        It = "." + St,
        ...
        Ot = {
            HIDE: "hide" + It,
            HIDE_PREVENTED: "hidePrevented" + It,
            HIDDEN: "hidden" + It,
            SHOW: "show" + It,
            SHOWN: "shown" + It,
            FOCUSIN: "focusin" + It,
        ...
        Ht = ".sticky-top",
        Mt = ((xt = Rt.prototype).toggle = function(t) {
            return this._isShown ? this.hide() : this.show(t)
        }, xt.show = function(t) {
            var e = this;
            if (!this._isShown && !this._isTransitioning) {
                p(this._element).hasClass(Pt) && (this._isTransitioning = !0);
                var i = p.Event(Ot.SHOW, {
                    relatedTarget: t
                });
                p(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(Ot.CLICK_DISMISS, '[data-dismiss="modal"]', function(t) {
                    return e.hide(t)
                }), p(this._dialog).on(Ot.MOUSEDOWN_DISMISS, function() {
                    p(e._element).one(Ot.MOUSEUP_DISMISS, function(t) {
            ...
            if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                var i = p.Event(Ot.HIDE);
                if (p(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                    this._isShown = !1;
                    var n = p(this._element).hasClass(Pt);
                    if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(Ot.FOCUSIN), p(this._element).removeClass(Lt), p(this._element).off(Ot.CLICK_DISMISS), p(this._dialog).off(Ot.MOUSEDOWN_DISMISS), n) {
            ...
            [window, this._element, this._dialog].forEach(function(t) {
                return p(t).off(It)
            }), p(document).off(Ot.FOCUSIN), p.removeData(this._element, St), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
        }, xt.handleUpdate = function() {
            this._adjustDialog()
        }, xt._getConfig = function(t) {
            return t = r({}, kt, {}, t), m.typeCheckConfig(Tt, t, Dt), t
        }, xt._triggerBackdropTransition = function() {
            var t = this;
            if ("static" === this._config.backdrop) {
                var e = p.Event(Ot.HIDE_PREVENTED);
            ...
            var e = this,
                i = p(this._element).hasClass(Pt),
                n = this._dialog ? this._dialog.querySelector(".modal-body") : null;

            function s() {
                e._config.focus && e._element.focus(), e._isTransitioning = !1, p(e._element).trigger(o)
            }
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass("modal-dialog-scrollable") && n ? n.scrollTop = 0 : this._element.scrollTop = 0, i && m.reflow(this._element), p(this._element).addClass(Lt), this._config.focus && this._enforceFocus();
            var o = p.Event(Ot.SHOWN, {
                relatedTarget: t
            });
            if (i) {
                var r = m.getTransitionDurationFromElement(this._dialog);
                p(this._dialog).one(m.TRANSITION_END, s).emulateTransitionEnd(r)
            } else s()
        }, xt._enforceFocus = function() {
            var e = this;
            p(document).off(Ot.FOCUSIN).on(Ot.FOCUSIN, function(t) {
                document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus()
            })
        }, xt._setEscapeEvent = function() {
            var e = this;
            this._isShown && this._config.keyboard ? p(this._element).on(Ot.KEYDOWN_DISMISS, function(t) {
                27 === t.which && e._triggerBackdropTransition()
            }) : this._isShown || p(this._element).off(Ot.KEYDOWN_DISMISS)
        }, xt._setResizeEvent = function() {
            var e = this;
            this._isShown ? p(window).on(Ot.RESIZE, function(t) {
                return e.handleUpdate(t)
            }) : p(window).off(Ot.RESIZE)
        }, xt._hideModal = function() {
            var t = this;
            this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                p(document.body).removeClass(Nt), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(Ot.HIDDEN)
            })
        }, xt._removeBackdrop = function() {
            this._backdrop && (p(this._backdrop).remove(), this._backdrop = null)
        }, xt._showBackdrop = function(t) {
            var e = this,
                i = p(this._element).hasClass(Pt) ? Pt : "";
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), p(this._backdrop).appendTo(document.body), p(this._element).on(Ot.CLICK_DISMISS, function(t) {
                        e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
                    }), i && m.reflow(this._backdrop), p(this._backdrop).addClass(Lt), !t) return;
                if (!i) return void t();
                var n = m.getTransitionDurationFromElement(this._backdrop);
                p(this._backdrop).one(m.TRANSITION_END, t).emulateTransitionEnd(n)
            } else if (!this._isShown && this._backdrop) {
                p(this._backdrop).removeClass(Lt);
                var s = function() {
                    e._removeBackdrop(), t && t()
                };
                if (p(this._element).hasClass(Pt)) {
            ...
            if (this._isBodyOverflowing) {
                var t = [].slice.call(document.querySelectorAll(zt)),
            ...
            return this.each(function() {
                var t = p(this).data(St),
                    e = r({}, kt, {}, p(this).data(), {}, "object" == typeof i && i ? i : {});
                if (t || (t = new Rt(this, e), p(this).data(St, t)), "string" == typeof i) {
                    if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                    t[i](n)
    ...
    p(document).on(Ot.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
        var e, i = this,
            n = m.getSelectorFromElement(this);
        n && (e = document.querySelector(n));
        var s = p(e).data(St) ? "toggle" : r({}, p(e).data(), {}, p(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var o = p(e).one(Ot.SHOW, function(t) {
            t.isDefaultPrevented() || o.one(Ot.HIDDEN, function() {
                p(i).is(":visible") && i.focus()
            })
        });
        Mt._jQueryInterface.call(p(e), s, this)
    }), p.fn[Tt] = Mt._jQueryInterface, p.fn[Tt].Constructor = Mt, p.fn[Tt].noConflict = function() {
        return p.fn[Tt] = At, Mt._jQueryInterface
    };
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(o), a = [].slice.call(i.body.querySelectorAll("*")), n = function(t) {
                ...
                n.forEach(function(t) {
                    ! function(t, e) {
                        ...
                        if (-1 !== e.indexOf(i)) return -1 === Ft.indexOf(i) || Boolean(t.nodeValue.match(Wt) || t.nodeValue.match($t));
    ...
    var Bt, Ut = "tooltip",
        ...
        oe = "hover",
        re = "focus",
        ae = ((Bt = le.prototype).enable = function() {
            this._isEnabled = !0
        }, Bt.disable = function() {
            this._isEnabled = !1
            ...
            if (this._isEnabled)
                if (t) {
                    ...
                    if (p(this.getTipElement()).hasClass(se)) return void this._leave(null, this);
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                s.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && p(s).addClass(ne);
                var r = "function" == typeof this.config.placement ? this.config.placement.call(this, s, this.element) : this.config.placement,
                    a = this._getAttachment(r);
                this.addAttachmentClass(a);
                var l = this._getContainer();
                p(s).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(s).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new u(this.element, s, this._getPopperConfig(a)), p(s).addClass(se), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                var h = function() {
                    e.config.animation && e._fixTransition();
                    var t = e._hoverState;
                    e._hoverState = null, p(e.element).trigger(e.constructor.Event.SHOWN), "out" === t && e._leave(null, e)
                };
                if (p(this.tip).hasClass(ne)) {
                    var c = m.getTransitionDurationFromElement(this.tip);
                    p(this.tip).one(m.TRANSITION_END, h).emulateTransitionEnd(c)
                } else h()
            }
        }, Bt.hide = function(t) {
            function e() {
                i._hoverState !== ee && n.parentNode && n.parentNode.removeChild(n), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), p(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), t && t()
            }
            var i = this,
                n = this.getTipElement(),
                s = p.Event(this.constructor.Event.HIDE);
            if (p(this.element).trigger(s), !s.isDefaultPrevented()) {
                if (p(n).removeClass(se), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger.click = !1, this._activeTrigger[re] = !1, this._activeTrigger[oe] = !1, p(this.tip).hasClass(ne)) {
                    var o = m.getTransitionDurationFromElement(n);
                    p(n).one(m.TRANSITION_END, e).emulateTransitionEnd(o)
                } else e();
                this._hoverState = ""
            }
        }, Bt.update = function() {
            ...
            p(this.getTipElement()).addClass(Yt + "-" + t)
        }, Bt.getTipElement = function() {
            return this.tip = this.tip || p(this.config.template)[0], this.tip
        }, Bt.setContent = function() {
            var t = this.getTipElement();
            this.setElementContent(p(t.querySelectorAll(".tooltip-inner")), this.getTitle()), p(t).removeClass(ne + " " + se)
        }, Bt.setElementContent = function(t, e) {
            "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = qt(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text())
            ...
            this.config.trigger.split(" ").forEach(function(t) {
                if ("click" === t) p(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(t) {
                    return n.toggle(t)
                });
                else if ("manual" !== t) {
                    var e = t === oe ? n.constructor.Event.MOUSEENTER : n.constructor.Event.FOCUSIN,
                        i = t === oe ? n.constructor.Event.MOUSELEAVE : n.constructor.Event.FOCUSOUT;
                ...
                n.element && n.hide()
            }, p(this.element).closest(".modal").on("hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = r({}, this.config, {
                trigger: "manual",
                selector: ""
            }) : this._fixTitle()
            ...
            var i = this.constructor.DATA_KEY;
            (e = e || p(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(i, e)), t && (e._activeTrigger["focusout" === t.type ? re : oe] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
            ...
            return Object.keys(e).forEach(function(t) {
                -1 !== Xt.indexOf(t) && delete e[t]
            }), "number" == typeof(t = r({}, this.constructor.Default, {}, e, {}, "object" == typeof t && t ? t : {})).delay && (t.delay = {
                show: t.delay,
                hide: t.delay
            }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), m.typeCheckConfig(Ut, t, this.constructor.DefaultType), t.sanitize && (t.template = qt(t.template, t.whiteList, t.sanitizeFn)), t
            ...
            null === t.getAttribute("x-placement") && (p(t).removeClass(ne), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
        }, le._jQueryInterface = function(i) {
            return this.each(function() {
                var t = p(this).data(Qt),
                    e = "object" == typeof i && i;
                if ((t || !/dispose|hide/.test(i)) && (t || (t = new le(this, e), p(this).data(Qt, t)), "string" == typeof i)) {
                    if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                    t[i]()
                }
            })
    ...
    p.fn[Ut] = ae._jQueryInterface, p.fn[Ut].Constructor = ae, p.fn[Ut].noConflict = function() {
        return p.fn[Ut] = Vt, ae._jQueryInterface
    };
    var he = "popover",
        ce = "bs.popover",
        ue = "." + ce,
        ...
        _e = function(t) {
            ...
            return s.isWithContent = function() {
                ...
                p(this.getTipElement()).addClass(fe + "-" + t)
                ...
                return this.each(function() {
                    ...
                    if ((t || !/dispose|hide/.test(i)) && (t || (t = new n(this, e), p(this).data(ce, t)), "string" == typeof i)) {
                        if (void 0 === t[i]) throw new TypeError('No method named "' + i + '"');
                        t[i]()
                    }
                })
    ...
    p.fn[he] = _e._jQueryInterface, p.fn[he].Constructor = _e, p.fn[he].noConflict = function() {
        return p.fn[he] = de, _e._jQueryInterface
    };
    var ye, we = "scrollspy",
        be = "bs.scrollspy",
        Ce = "." + be,
        ...
        De = ".list-group-item",
        Oe = "position",
        Ne = ((ye = Pe.prototype).refresh = function() {
            var e = this,
                t = this._scrollElement === this._scrollElement.window ? "offset" : Oe,
                s = "auto" === this._config.method ? t : this._config.method,
                o = s === Oe ? this._getScrollTop() : 0;
            this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
                var e, i = m.getSelectorFromElement(t);
                if (i && (e = document.querySelector(i)), e) {
                    var n = e.getBoundingClientRect();
                    if (n.width || n.height) return [p(e)[s]().top + o, i]
                }
                return null
            }).filter(function(t) {
                return t
            ...
            p.removeData(this._element, be), p(this._scrollElement).off(Ce), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
        }, ye._getConfig = function(t) {
            if ("string" != typeof(t = r({}, xe, {}, "object" == typeof t && t ? t : {})).target) {
                var e = p(t.target).attr("id");
                e || (e = m.getUID(we), p(t.target).attr("id", e)), t.target = "#" + e
            }
            return m.typeCheckConfig(we, t, Te), t
        }, ye._getScrollTop = function() {
            return this._scrollElement === window ? this._scrollElement.pageYOffset : this._scrollElement.scrollTop
        }, ye._getScrollHeight = function() {
            return this._scrollElement.scrollHeight || Math.max(document.body.scrollHeight, document.documentElement.scrollHeight)
        }, ye._getOffsetHeight = function() {
            return this._scrollElement === window ? window.innerHeight : this._scrollElement.getBoundingClientRect().height
        }, ye._process = function() {
        ...
        }, ye._activate = function(e) {
            this._activeTarget = e, this._clear();
            var t = this._selector.split(",").map(function(t) {
                    return t + '[data-target="' + e + '"],' + t + '[href="' + e + '"]'
                }),
                i = p([].slice.call(document.querySelectorAll(t.join(","))));
            i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(Ie), i.addClass(Ie)) : (i.addClass(Ie), i.parents(Ae).prev(ke + ", " + De).addClass(Ie), i.parents(Ae).prev(".nav-item").children(ke).addClass(Ie)), p(this._scrollElement).trigger(Se.ACTIVATE, {
                relatedTarget: e
            })
        }, ye._clear = function() {
            ...
            return this.each(function() {
                var t = p(this).data(be);
                if (t || (t = new Pe(this, "object" == typeof e && e), p(this).data(be, t)), "string" == typeof e) {
                    if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                    t[e]()
                }
            })
    ...
    function Pe(t, e) {
        var i = this;
        this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + ke + "," + this._config.target + " " + De + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(Se.SCROLL, function(t) {
            return i._process(t)
        }), this.refresh(), this._process()
    }
    p(window).on(Se.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), e = t.length; e--;) {
            var i = p(t[e]);
            Ne._jQueryInterface.call(i, i.data())
        }
    }), p.fn[we] = Ne._jQueryInterface, p.fn[we].Constructor = Ne, p.fn[we].noConflict = function() {
        return p.fn[we] = Ee, Ne._jQueryInterface
    };
    var Le, je = "bs.tab",
        ze = "." + je,
        He = p.fn.tab,
        ...
        Fe = ".active",
        We = "> li > .active",
        $e = ((Le = qe.prototype).show = function() {
            var i = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Re) || p(this._element).hasClass("disabled"))) {
                var t, n, e = p(this._element).closest(".nav, .list-group")[0],
                    s = m.getSelectorFromElement(this._element);
                if (e) {
                    var o = "UL" === e.nodeName || "OL" === e.nodeName ? We : Fe;
                    n = (n = p.makeArray(p(e).find(o)))[n.length - 1]
                }
                var r = p.Event(Me.HIDE, {
                        relatedTarget: this._element
                    }),
                    a = p.Event(Me.SHOW, {
                        relatedTarget: n
            ...
            p.removeData(this._element, je), this._element = null
        }, Le._activate = function(t, e, i) {
            function n() {
                return s._transitionComplete(t, o, i)
            }
            var s = this,
                o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Fe) : p(e).find(We))[0],
                r = i && o && p(o).hasClass("fade");
            if (o && r) {
                var a = m.getTransitionDurationFromElement(o);
                p(o).removeClass("show").one(m.TRANSITION_END, n).emulateTransitionEnd(a)
            } else n()
        }, Le._transitionComplete = function(t, e, i) {
            if (e) {
                p(e).removeClass(Re);
                var n = p(e.parentNode).find("> .dropdown-menu .active")[0];
                n && p(n).removeClass(Re), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
            }
            if (p(t).addClass(Re), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), m.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && p(t.parentNode).hasClass("dropdown-menu")) {
            ...
            return this.each(function() {
                var t = p(this),
                    e = t.data(je);
                if (e || (e = new qe(this), t.data(je, e)), "string" == typeof i) {
    ...
    p(document).on(Me.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(), $e._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = $e._jQueryInterface, p.fn.tab.Constructor = $e, p.fn.tab.noConflict = function() {
        return p.fn.tab = He, $e._jQueryInterface
    };
    var Be, Ue = "toast",
        Qe = "bs.toast",
        Ke = "." + Qe,
        ...
        ti = ((Be = ei.prototype).show = function() {
            var t = this,
                e = p.Event(Ye.SHOW);
            if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                this._config.animation && this._element.classList.add("fade");
                var i = function() {
                    t._element.classList.remove(Xe), t._element.classList.add(Ze), p(t._element).trigger(Ye.SHOWN), t._config.autohide && (t._timeout = setTimeout(function() {
                        t.hide()
                    }, t._config.delay))
                };
                if (this._element.classList.remove("hide"), m.reflow(this._element), this._element.classList.add(Xe), this._config.animation) {
            ...
            clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ze) && this._element.classList.remove(Ze), p(this._element).off(Ye.CLICK_DISMISS), p.removeData(this._element, Qe), this._element = null, this._config = null
        }, Be._getConfig = function(t) {
            return t = r({}, Je, {}, p(this._element).data(), {}, "object" == typeof t && t ? t : {}), m.typeCheckConfig(Ue, t, this.constructor.DefaultType), t
        }, Be._setListeners = function() {
            var t = this;
            p(this._element).on(Ye.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                return t.hide()
            })
        }, Be._close = function() {
            function t() {
                e._element.classList.add("hide"), p(e._element).trigger(Ye.HIDDEN)
            }
            var e = this;
            if (this._element.classList.remove(Ze), this._config.animation) {
                var i = m.getTransitionDurationFromElement(this._element);
                p(this._element).one(m.TRANSITION_END, t).emulateTransitionEnd(i)
            } else t()
        }, ei._jQueryInterface = function(i) {
            return this.each(function() {
                var t = p(this),
                    e = t.data(Qe);
                if (e || (e = new ei(this, "object" == typeof i && i), t.data(Qe, e)), "string" == typeof i) {
                    if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                    e[i](this)
                }
            })
    ...
    p.fn[Ue] = ti._jQueryInterface, p.fn[Ue].Constructor = ti, p.fn[Ue].noConflict = function() {
        return p.fn[Ue] = Ve, ti._jQueryInterface
    }, t.Alert = f, t.Button = A, t.Carousel = B, t.Collapse = ot, t.Dropdown = Ct, t.Modal = Mt, t.Popover = _e, t.Scrollspy = Ne, t.Tab = $e, t.Toast = ti, t.Tooltip = ae, t.Util = m, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}),
function(h) {
        ...
        return h(this).each(function(t, e) {
            ...
            s.attr("novalidate", "true"), o.attr("name", "EMAIL"), s.submit(function() {
                ...
                h.each(t, function(t, e) {
                    ...
                    data: i,
                    success: function(e) {
                        if ("success" === e.result) n = "We have sent you a confirmation email", r.removeClass("error").addClass("valid"), o.removeClass("error").addClass("valid");
                        else {
                            o.removeClass("valid").addClass("error"), r.removeClass("valid").addClass("error");
                            try {
                                var t = e.msg.split(" - ", 2);
                                if (void 0 === t[1]) n = e.msg;
                                else {
                                    var i = parseInt(t[0], 10);
                                    n = i.toString() === t[0] ? (t[0], t[1]) : e.msg
                                }
                            } catch (t) {
                                n = e.msg
                            }
                        }
                        "en" !== a.language && void 0 !== h.ajaxChimp.responses[n] && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[n]] && (n = h.ajaxChimp.translations[a.language][h.ajaxChimp.responses[n]]), r.html(n), r.show(2e3), a.callback && a.callback(e)
                    },
                    dataType: "jsonp",
                    error: function(t, e) {
                ...
                var e = "Submitting...";
                return "en" !== a.language && h.ajaxChimp.translations && h.ajaxChimp.translations[a.language] && h.ajaxChimp.translations[a.language].submit && (e = h.ajaxChimp.translations[a.language].submit), r.html(e).show(2e3), !1
            })
        }), this
    }
}(jQuery),
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            ...
            l.waypoint(function() {
                ...
                i = i.replace(/,/g, "");
                /^[0-9]+$/.test(i);
                for (var s = /^[0-9]+\.[0-9]+$/.test(i), o = s ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
                    var a = parseInt(i / e * r);
                    if (s && (a = parseFloat(i / e * r).toFixed(o)), n)
                        for (;
...
function(t) {
    ...
    t.prototype = {
        ...
        open: function(t) {
            ...
            if (!m.isOpen) {
                ...
                f("BeforeOpen"), m.st.showCloseBtn && (m.st.closeBtnInside ? (u(_, function(t, e, i, n) {
                    i.close_replaceWith = p(n.type)
                }), v += " mfp-close-btn-in") : m.wrap.append(p())), m.st.alignTop && (v += " mfp-align-top"), m.fixedContentPos ? m.wrap.css({
                ...
                return m.isIE7 && (h += " mfp-ie7"), h && m._addClassToMFP(h), m.updateItemHTML(), f("BuildControls"), c("html").css(a), m.bgOverlay.add(m.wrap).prependTo(m.st.prependTo || c(document.body)), m._lastFocusedEl = document.activeElement, setTimeout(function() {
                    m.content ? (m._addClassToMFP(b), m._setFocus()) : m.bgOverlay.addClass(b), g.on("focusin" + w, m._onFocusIn)
                }, 16), m.isOpen = !0, m.updateSize(r), f(y), t
            }
            m.updateItemHTML()
        },
        close: function() {
            m.isOpen && (f(h), m.isOpen = !1, m.st.removalDelay && !m.isLowIE && m.supportsTransition ? (m._addClassToMFP(i), setTimeout(function() {
                m._close()
        ...
        updateItemHTML: function() {
            ...
            var e = t.type;
            if (f("BeforeChange", [m.currItem ? m.currItem.type : "", e]), m.currItem = t, !m.currTemplate[e]) {
                var i = !!m.st[e] && m.st[e].markup;
                f("FirstMarkupParse", i), m.currTemplate[e] = !i || c(i)
            }
            s && s !== t.type && m.container.removeClass("mfp-" + s + "-holder");
            var n = m["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, m.currTemplate[e]);
            m.appendContent(n, e), t.preloaded = !0, f("Change", t), s = t.type, m.container.prepend(m.contentContainer), f("AfterChange")
        },
        appendContent: function(t, e) {
            (m.content = t) ? m.st.showCloseBtn && m.st.closeBtnInside && !0 === m.currTemplate[e] ? m.content.find(".mfp-close").length || m.content.append(p()) : m.content = t: m.content = "", f("BeforeAppend"), m.container.addClass("mfp-" + e + "-holder"), m.contentContainer.append(m.content)
        },
        parseEl: function(t) {
            var e, i = m.items[t];
            if ((i = i.tagName ? {
            ...
            return i.type = e || m.st.type || "inline", i.index = t, i.parsed = !0, m.items[t] = i, f("ElementParse", i), m.items[t]
        },
        ...
        updateStatus: function(t, e) {
            if (m.preloader) {
                ...
                f("UpdateStatus", i), t = i.status, e = i.text, m.preloader.html(e), m.preloader.find("a").on("click", function(t) {
        ...
        _hasScrollBar: function(t) {
            return (m.isIE7 ? g.height() : document.body.scrollHeight) > (t || C.height())
        },
        _setFocus: function() {
        ...
        _parseMarkup: function(s, t, e) {
            var o;
            e.data && (t = c.extend(e.data, t)), f(_, [s, t, e]), c.each(t, function(t, e) {
                if (void 0 === e || !1 === e) return !0;
                if (1 < (o = t.split("_")).length) {
                    var i = s.find(w + "-" + o[0]);
                    if (0 < i.length) {
                        var n = o[1];
                        "replaceWith" === n ? i[0] !== e[0] && i.replaceWith(e) : "img" === n ? i.is("img") ? i.attr("src", e) : i.replaceWith(c("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(o[1], e)
                    }
        ...
        if ("string" == typeof t)
            if ("open" === t) {
                ...
                i = n.items ? n.items[s] : (i = e, n.delegate && (i = i.find(n.delegate)), i.eq(s)), m._openClick({
                    mfpEl: i
                }, e, n)
            } else m.isOpen && m[t].apply(m, Array.prototype.slice.call(arguments, 1));
        else t = c.extend(!0, {}, t), a ? e.data("magnificPopup", t) : e[0].magnificPopup = t, m.addGroup(e, t);
        return e
    };
            ...
            getInline: function(t, e) {
                if (E(), t.src) {
                    ...
                    if (n.length) {
                        ...
                        s && s.tagName && (T || (x = i.hiddenClass, T = d(x), x = "mfp-" + x), S = n.after(T).detach().removeClass(x)), m.updateStatus("ready")
                    } else m.updateStatus("error", i.tNotFound), n = c("<div>");
    ...
    c.magnificPopup.registerModule(O, {
        ...
        proto: {
            initAjax: function() {
                m.types.push(O), D = m.st.ajax.cursor, u(l + "." + O, k), u("BeforeChange." + O, k)
            },
            getAjax: function(s) {
                ...
                var t = c.extend({
                    ...
                    success: function(t, e, i) {
                        ...
                        f("ParseAjax", n), m.appendContent(c(n.data), O), s.finished = !0, A(), m._setFocus(), setTimeout(function() {
                            m.wrap.addClass(b)
                        }, 16), m.updateStatus("ready"), f("AjaxContentAdded")
                    },
                    error: function() {
                        A(), s.finished = s.loadError = !0, m.updateStatus("error", m.st.ajax.tError.replace("%url%", s.src))
                    }
                }, m.st.ajax.settings);
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var t = m.st.image,
                    e = ".image";
                m.types.push("image"), u(y + e, function() {
                    "image" === m.currItem.type && t.cursor && c(document.body).addClass(t.cursor)
                }), u(l + e, function() {
                    t.cursor && c(document.body).removeClass(t.cursor), C.off("resize" + w)
            ...
            _onImageHasSize: function(t) {
                t.img && (t.hasSize = !0, N && clearInterval(N), t.isCheckingImgSize = !1, f("ImageHasSize", t), t.imgHidden && (m.content && m.content.removeClass("mfp-loading"), t.imgHidden = !1))
            },
                ...
                var i = 0,
                    ...
                    s = function(t) {
                        N && clearInterval(N), N = setInterval(function() {
                            return 0 < n.naturalWidth ? void m._onImageHasSize(e) : (200 < i && clearInterval(N), void(3 === ++i ? s(10) : 40 === i ? s(50) : 100 === i && s(500)))
                        }, t)
                    };
                s(1)
            },
            getImage: function(t, e) {
                var i = 0,
                    n = function() {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === m.currItem && (m._onImageHasSize(t), m.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, f("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : s())
                    },
                    s = function() {
                ...
                if (r.length) {
                    ...
                    a.className = "mfp-img", t.el && t.el.find("img").length && (a.alt = t.el.find("img").attr("alt")), t.img = c(a).on("load.mfploader", n).on("error.mfploader", s), a.src = t.src, r.is("img") && (t.img = t.img.clone()), 0 < (a = t.img[0]).naturalWidth ? t.hasSize = !0 : a.width || (t.hasSize = !1)
                }
                ...
                }, t), m.resizeImage(), t.hasSize ? (N && clearInterval(N), t.loadError ? (e.addClass("mfp-loading"), m.updateStatus("error", o.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), m.updateStatus("ready"))) : (m.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), m.findImageSize(t))), e
            }
        }
    });
    var P;
            ...
            initZoom: function() {
                ...
                if (o.enabled && m.supportsTransition) {
                    ...
                    u("BuildControls" + e, function() {
                        if (m._allowZoom()) {
                            if (clearTimeout(s), m.content.css("visibility", "hidden"), !(t = m._getItemToZoom())) return void n();
    ...
    function L(t) {
        if (m.currTemplate[j]) {
            var e = m.currTemplate[j].find("iframe");
    ...
    c.magnificPopup.registerModule(j, {
        ...
        proto: {
            initIframe: function() {
                m.types.push(j), u("BeforeChange", function(t, e, i) {
                    e !== i && (e === j ? L() : i === j && L(!0))
                }), u(l + "." + j, function() {
                    L()
                })
    ...
    c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var o = m.st.gallery,
                    t = ".mfp-gallery";
                return m.direction = !0, !(!o || !o.enabled) && (v += " mfp-gallery", u(y + t, function() {
            ...
            _preloadItem: function(t) {
                if (t = z(t), !m.items[t].preloaded) {
                    var e = m.items[t];
                    e.parsed || (e = m.parseEl(t)), f("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
                        e.hasSize = !0
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var i = m.st.retina,
                        n = i.ratio;
                    1 < (n = isNaN(n) ? n() : n) && (u("ImageHasSize." + M, function(t, e) {
                        e.img.css({
...
function(t) {
    ...
    function n(t) {
        var e, i = t || window.event,
            ...
            o = 0,
            r = 0;
        if ((t = c.event.fix(i)).type = "mousewheel", "detail" in i && (r = -1 * i.detail), "wheelDelta" in i && (r = i.wheelDelta), "wheelDeltaY" in i && (r = i.wheelDeltaY), "wheelDeltaX" in i && (o = -1 * i.wheelDeltaX), "axis" in i && i.axis === i.HORIZONTAL_AXIS && (o = -1 * r, r = 0), s = 0 === r ? o : r, "deltaY" in i && (s = r = -1 * i.deltaY), "deltaX" in i && (o = i.deltaX, 0 === r && (s = -1 * o)), 0 !== r || 0 !== o) {
            if (1 === i.deltaMode) {
                var a = c.data(this, "mousewheel-line-height");
                s *= a, r *= a, o *= a
            } else if (2 === i.deltaMode) {
                var l = c.data(this, "mousewheel-page-height");
                s *= l, r *= l, o *= l
            }
            if (e = Math.max(Math.abs(r), Math.abs(o)), (!d || e < d) && g(i, d = e) && (d /= 40), g(i, e) && (s /= 40, o /= 40, r /= 40), s = Math[1 <= s ? "floor" : "ceil"](s / d), o = Math[1 <= o ? "floor" : "ceil"](o / d), r = Math[1 <= r ? "floor" : "ceil"](r / d), p.settings.normalizeOffset && this.getBoundingClientRect) {
                var h = this.getBoundingClientRect();
                t.offsetX = t.clientX - h.left, t.offsetY = t.clientY - h.top
            }
            return t.deltaX = o, t.deltaY = r, t.deltaFactor = d, t.deltaMode = 0, n.unshift(t, s, o, r), u && window.clearTimeout(u), u = window.setTimeout(m, 200), (c.event.dispatch || c.event.handle).apply(this, n)
        }
    }
    ...
    c.extend(c.fn, {
        validate: function(t) {
            if (this.length) {
                ...
                return n || (this.attr("novalidate", "novalidate"), n = new c.validator(t, this[0]), c.data(this[0], "validator", n), n.settings.onsubmit && (this.on("click.validate", ":submit", function(t) {
                    ...
                    function t() {
                        var t, e;
                        return n.submitButton && (n.settings.submitHandler || n.formSubmitted) && (t = c("<input type='hidden'/>").attr("name", n.submitButton.name).val(c(n.submitButton).val()).appendTo(n.currentForm)), !(n.settings.submitHandler && !n.settings.debug) || (e = n.settings.submitHandler.call(n, n.currentForm, i), t && t.remove(), void 0 !== e && e)
                    }
        ...
        prototype: {
            init: function() {
                function t(t) {
                    ...
                    if (!this.form && e && (this.form = c(this).closest("form")[0], this.name = c(this).attr("name")), o === this.form) {
                        var i = c.data(this.form, "validator"),
                            n = "on" + t.type.replace(/^validate/, ""),
                            s = i.settings;
                        s[n] && !c(this).is(s.ignore) && s[n].call(i, this, t)
                    }
                }
            ...
            elements: function() {
                ...
                return c(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    return !t && i.settings.debug && window.console && console.error("%o has no name assigned", this), e && (this.form = c(this).closest("form")[0], this.name = t), !(this.form !== i.currentForm || t in n || !i.objectLength(c(this).rules()) || (n[t] = !0, 0))
                })
            },
            clean: function(t) {
                return c(t)[0]
            ...
            elementValue: function(t) {
                ...
                return "radio" === s || "checkbox" === s ? this.findByName(t.name).filter(":checked").val() : "number" === s && void 0 !== t.validity ? t.validity.badInput ? "NaN" : n.val() : (e = o ? n.text() : n.val(), "file" === s ? "C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (i = e.lastIndexOf("/")) ? e.substr(i + 1) : 0 <= (i = e.lastIndexOf("\\")) ? e.substr(i + 1) : e : "string" == typeof e ? e.replace(/\r/g, "") : e)
            },
            check: function(e) {
                ...
                for (i in "function" == typeof o.normalizer ? s = o.normalizer : "function" == typeof this.settings.normalizer && (s = this.settings.normalizer), s && (l = s.call(e, l), delete o.normalizer), o) {
                    n = {
                        method: i,
                        parameters: o[i]
                    };
        ...
        dataRules: function(t) {
            var e, i, n = {},
                s = c(t),
                o = t.getAttribute("type");
            for (e in c.validator.methods) "" === (i = s.data("rule" + e.charAt(0).toUpperCase() + e.substring(1).toLowerCase())) && (i = !0), this.normalizeAttributeRule(n, o, e, i);
            return n
        },
        ...
        methods: {
            ...
            step: function(t, e, i) {
                ...
                var o, r = c(e).attr("type"),
                    a = "Step attribute on input type " + r + " is not supported.",
                    l = new RegExp("\\b" + r + "\\b"),
                    h = !0;
                if (r && !l.test(["text", "number", "range"].join())) throw new Error(a);
                return o = n(i), (n(t) > o || s(t) % s(i) != 0) && (h = !1), this.optional(e) || h
            },
    ...
    i.prototype.add = function(t) {
        ...
        for (var s in this.handleScroll(), t = {
            ...
            for (var r in this.waypoints[s]) {
                var a, l, h, c, u = this.waypoints[s][r],
                    d = u.options.offset,
                    f = u.triggerPoint,
                    p = 0,
                    m = null == f;
...
function(t, e) {
    ...
    function w(t) {
        ...
        var e = _(t),
            ...
            n = e.overflowX,
            s = e.overflowY;
        return /(auto|scroll)/.test(i + s + n) ? t : w(y(t))
    }

    function b(t) {
        var e = t && t.offsetParent,
            i = e && e.nodeName;
        return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TD", "TABLE"].indexOf(e.nodeName) && "static" === _(e, "position") ? b(e) : e : window.document.documentElement
    }
    ...
    function n(t, e, i, n) {
        return L(e["offset" + t], i["client" + t], i["offset" + t], q() ? i["offset" + t] + n["margin" + ("Height" === t ? "Top" : "Left")] + n["margin" + ("Height" === t ? "Bottom" : "Right")] : 0)
    }
    ...
    function I(t, e) {
        ...
        return (i ? e.contains(r) : e === r && "BODY" !== r.nodeName) && (c = function(t, e, i) {
    ...
    function f(t, e, i, n) {
        var s, o, r, a, l, h, c, u = {
            ...
            d = C(t, e);
        if ("viewport" === n) s = d, o = window.document.documentElement, r = I(s, o), a = L(o.clientWidth, window.innerWidth || 0), l = L(o.clientHeight, window.innerHeight || 0), h = E(o), c = E(o, "left"), u = T({
            ...
            var f;
            "scrollParent" === n ? "BODY" === (f = w(y(t))).nodeName && (f = window.document.documentElement) : f = "window" === n ? window.document.documentElement : n;
            var p = I(f, d);
            if ("HTML" !== f.nodeName || function t(e) {
                    var i = e.nodeName;
                    return "BODY" !== i && "HTML" !== i && ("fixed" === _(e, "position") || t(y(e)))
                }(d)) u = p;
            else {
                var m = x(),
                    g = m.height,
    ...
    function k(t, e, i) {
        ...
        var n = p(t),
            ...
            l = o ? "height" : "width",
            h = o ? "width" : "height";
        return s[r] = e[r] + e[l] / 2 - n[l] / 2, s[a] = i === a ? e[a] - n[h] : e[A(a)], s
    }
    ...
    function O(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && o(e) && (i.offsets.popper = T(i.offsets.popper), i.offsets.reference = T(i.offsets.reference), i = e(i, t))
        }), i
    }
    ...
    function e(t, e, i, n) {
        ...
        return function t(e, i, n, s) {
            ...
            r.addEventListener(i, n, {
                passive: !0
            }), o || t(w(r.parentNode), i, n, s), s.push(r)
    ...
    function h(i, n) {
        Object.keys(n).forEach(function(t) {
            var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && d(n[t]) && (e = "px"), i.style[t] = n[t] + e
        })
    }
    ...
    function s(t, e) {
        var i = 1 < arguments.length && void 0 !== e && e,
            n = K.indexOf(t),
            s = K.slice(n + 1).concat(K.slice(0, n));
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, n) {
                    var s, o = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
                        ...
                        a = o[2];
                    if (!r) return t;
                    if (0 !== a.indexOf("%")) return "vh" !== a && "vw" !== a ? r : ("vh" === a ? L(document.documentElement.clientHeight, window.innerHeight || 0) : L(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r;
                    switch (a) {
                        case "%p":
                            s = i;
                            break;
    ...
    for (var v = Math.min, P = Math.floor, L = Math.max, r = ["native code", "[object MutationObserverConstructor]"], j = "undefined" != typeof window, z = ["Edge", "Trident", "Firefox"], H = 0, M = 0; M < z.length; M += 1)
        if (j && 0 <= navigator.userAgent.indexOf(z[M])) {
            H = 1;
            break
        }
    function R(t, e, i) {
    ...
    var F, W, $ = j && (W = window.MutationObserver, r.some(function(t) {
    ...
    function G(t, e) {
        ...
        }, this.update = $(this.update.bind(this)), this.options = U({}, G.Defaults, n), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = t.jquery ? t[0] : t, this.popper = e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(U({}, G.Defaults.modifiers, n.modifiers)).forEach(function(t) {
            i.options.modifiers[t] = U({}, G.Defaults.modifiers[t] || {}, n.modifiers ? n.modifiers[t] : {})
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(t, e) {
                    var i, n = e.offset,
                        ...
                        a = o.reference,
                        l = s.split("-")[0];
                    return i = d(+n) ? [+n, 0] : g(n, r, a, l), "left" === l ? (r.top += i[0], r.left -= i[1]) : "right" === l ? (r.top += i[0], r.left += i[1]) : "top" === l ? (r.left += i[0], r.top -= i[1]) : "bottom" === l && (r.left += i[0], r.top += i[1]), t.popper = r, t
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function(t, n) {
                    ...
                    var s = f(t.instance.popper, t.instance.reference, n.padding, e);
                    n.boundaries = s;
                    var i = n.priority,
                        o = t.offsets.popper,
                        r = {
                            primary: function(t) {
                                var e = o[t];
                                return o[t] < s[t] && !n.escapeWithReference && (e = L(o[t], s[t])), R({}, t, e)
                            },
                            secondary: function(t) {
                                var e = "right" === t ? "left" : "top",
                                    i = o[e];
                                return o[t] > s[t] && !n.escapeWithReference && (i = v(o[e], s[t] - ("right" === t ? o.width : o.height))), R({}, e, i)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    var f = r[h] + r[l] / 2 - d / 2 - T(t.offsets.popper)[h];
                    return f = L(v(o[l] - d, f), 0), t.arrowElement = i, t.offsets.arrow = {}, t.offsets.arrow[h] = Math.round(f), t.offsets.arrow[c] = "", t
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(p, m) {
                    ...
                    return w.forEach(function(t, e) {
                        ...
                        var i, n = p.offsets.popper,
                            ...
                            h = o(n.top) < o(g.top),
                            c = o(n.bottom) > o(g.bottom),
                            u = "left" === v && a || "right" === v && l || "top" === v && h || "bottom" === v && c,
                            d = -1 !== ["top", "bottom"].indexOf(v),
                            f = !!m.flipVariations && (d && "start" === y && a || d && "end" === y && l || !d && "start" === y && h || !d && "end" === y && c);
                        (r || u || f) && (p.flipped = !0, (r || u) && (v = w[e + 1]), f && (y = "end" === (i = y) ? "start" : "start" === i ? "end" : i), p.placement = v + (y ? "-" + y : ""), p.offsets.popper = U({}, p.offsets.popper, k(p.instance.popper, p.offsets.reference, p.placement)), p = O(p.instance.modifiers, p, "flip"))
                    }), p
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(t) {
                    ...
                    return s[r ? "left" : "top"] = o[e] - (a ? s[r ? "width" : "height"] : 0), t.placement = A(e), t.offsets.popper = T(s), t
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r, a, l = void 0 === o ? e.gpuAcceleration : o,
                        ...
                        p = N("transform");
                    if (a = "bottom" == d ? -h.height + u.bottom : u.top, r = "right" == f ? -h.width + u.right : u.left, l && p) c[p] = "translate3d(" + r + "px, " + a + "px, 0)", c[d] = 0, c[f] = 0, c.willChange = "transform";
                    else {
                        var m = "bottom" == d ? -1 : 1,
                            g = "right" == f ? -1 : 1;
                        c[d] = a * m, c[f] = r * g, c.willChange = d + ", " + f
                    }
                    var v = {
                        "x-placement": t.placement
                    };
                    return t.attributes = U({}, v, t.attributes), t.styles = U({}, c, t.styles), t
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
...
function(t, e) {
    ...
    var r = function(t, e, i) {
        ...
        a = window.WeakMap || window.MozWeakMap || (r(f, [{
            key: "get",
            value: function(t) {
        ...
        l = window.MutationObserver || window.WebkitMutationObserver || window.MozMutationObserver || (r(d, [{
            key: "observe",
            value: function() {}
        }]), d.notSupported = !0, d),
        h = window.getComputedStyle || function(i) {
            var n = /(\-([a-z]){1})/g;
            return {
                getPropertyValue: function(t) {
                    "float" === t && (t = "styleFloat"), n.test(t) && t.replace(n, function(t, e) {
        ...
        c = (r(u, [{
            ...
            value: function() {
                ...
                this.disabled() || (n(this.config.scrollContainer || window, "scroll", this.scrollHandler), n(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live && new l(function(t) {
            ...
            key: "vendorCSS",
            value: function(t, e) {
                for (var i = h(t), n = i.getPropertyCSSValue(e), s = 0; s < this.vendors.length; s++) {
    ...
    function u() {
        ...
        i(this, u), this.defaults = {
            ...
            return t
        }(t, this.defaults), null != t.scrollContainer && (this.config.scrollContainer = document.querySelector(t.scrollContainer)), this.animationNameCache = new a, this.wowEvent = function(t, e, i, n) {
            var s = !(arguments.length <= 1 || void 0 === e) && e,
                o = !(arguments.length <= 2 || void 0 === i) && i,
                r = arguments.length <= 3 || void 0 === n ? null : n,
                a = void 0;
            return null != document.createEvent ? (a = document.createEvent("CustomEvent")).initCustomEvent(t, s, o, r) : null != document.createEventObject ? (a = document.createEventObject()).eventType = t : a.eventName = t, a
        }(this.config.boxClass)
    }

    function d() {
        i(this, d), "undefined" != typeof console && null !== console && (console.warn("MutationObserver is not supported by your browser."), console.warn("WOW.js cannot detect dom mutations, please call .sync() after loading new content."))
    }

    function f() {
        i(this, f), this.keys = [], this.values = []
    }
